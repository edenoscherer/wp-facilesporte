...
<body>
	<section id="all">
		...
		<!-- /header -->
		<!-- main content -->
		<section id="main-content" class="page products">
			<header class="page-header with-bg" style="background-image: url('http://lorempixel.com/1500/300');">
				<h1 class="page-title">Produtos da <strong>linha Esporte</strong></h1>
			</header>
			<div class="container">
